<section class="benefit-section">
    ...
    <div class="benefit-content d-flex flex-column flex-md-row w-100 gap-md-4 gap-lg-5 mt-5">
        <div class="w-100 w-md-50 d-flex flex-column">
            <h2 class="benefit-content-title mb-3 mb-lg-2">Optimalkan potensi karyawan Anda
                dengan Learning Management System (LMS)</h2>
            <div class="d-block d-md-none w-100 benefit-img"></div>
            <span class="benefit-content-description">Berdayakan tim Anda untuk mencapai kesuksesan dengan data yang
                akurat dan solusi pembelajaran yang
                terintegrasi. Transformasikan pengelolaan sumber daya manusia Anda dan hadirkan produktivitas yang
                unggul
                dengan LMS kami!</span>
            <div class="d-flex flex-column gap-2">
                <div class="d-flex gap-2 align-items-center justify-content-start benefit-content-list">
                    ...
                    <h3 class="benefit-content-title-list">Issued Certificate</h3>
                </div>
                <div class="benefit-content-list-description w-75">
                    <span class="">Berikan kemudahan dalam mengatur dan mendistribusikan sertifikat kepada setiap
                        karyawan.</span>
                </div>
            </div>
            <div class="d-flex flex-column gap-2">
                <div class="d-flex gap-2 align-items-center justify-content-start benefit-content-list">
                    <img src="{{ asset('assets/image/check_small.png') }}" width="30" alt="check small">
                    <h3 class="benefit-content-title-list">On Boarding</h3>
                </div>
                <div class="benefit-content-list-description w-75">
                    <span class="">Memastikan setiap karyawan siap memberikan kontribusi maksimal sejak hari pertama mereka bergabung</span>
                </div>
            </div>
            <div class="d-flex flex-column gap-2">
                <div class="d-flex gap-2 align-items-center justify-content-start benefit-content-list">
                    <img src="{{ asset('assets/image/check_small.png') }}" width="30" alt="check small">
                    <h3 class="benefit-content-title-list">Training on-demand</h3>
                </div>
                <div class="benefit-content-list-description w-75">
                    <span class="">Training On-Demand yang berfokus pada pengalaman pengguna, pelatihan berkualitas tinggi menjadi lebih mudah diakses dan disesuaikan dengan kebutuhan Anda.</span>
                </div>
            </div>
        </div>
